        ...
        <div className="mb-12">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <div className="relative w-16 h-16">
              <div className="absolute inset-0 bg-gradient-to-tr from-[#38BDF8] via-[#60A5FA] to-[#93C5FD] rounded-2xl shadow-lg shadow-[#38BDF8]/50"></div>
              <div className="absolute inset-[3px] bg-gradient-to-br from-[#0F172A] to-[#1e293b] rounded-xl flex items-center justify-center">
